  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/admin/billing" element={checkAdminRole() ||<AdminBilling />}></Route>
        <Route path="/admin/setting" element={checkAdminRole() ||<AdminSetting />}></Route>
        <Route path="/admin/guide" element={checkAdminRole() ||<AdminGuide />}></Route>
        <Route path="/admin/package" element={checkAdminRole() ||<AdminPackage />}></Route>
        <Route path="/admin/role" element={checkAdminRole() ||<AdminRole />}></Route>

        {/* USER ROUTE*/}
        <Route path="/login" element={<Login />}></Route>

        {/* USER PROFILE*/}
        <Route path="/user" element={checkLoggedIn() ||<UserProfile />}></Route>
        <Route path="/user/subscribe" element={checkLoggedIn() ||<UserSubscribe />}></Route>
        <Route path="/user/subscribe/payment/:billing_id" element={checkLoggedIn() ||<UserPayment />}></Route>
        <Route
        ...
        <Route path="/subscribe" element={checkLoggedIn() ||<Subscribe />}></Route>

        {/* USER ORG*/}
        <Route path="/organizations" element={checkLoggedIn() || <Organizations />}></Route>
        <Route
        ...
        ></Route>
        <Route path="/serverEmpty" element={checkLoggedIn() || <ServerEmpty />}></Route>

        <Route path="/server" element={checkLoggedIn() || <ServerConfig />}></Route>
