    ...
    <nav className="bg-white shadow-md">
      ...
      <div className="md:hidden hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a href="../#featureNew" className="text-gray-900 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">Feature News</a>
          <a href="../#aboutUs" className="text-gray-900 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">About Us</a>
