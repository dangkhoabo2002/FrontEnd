      ...
      <div className="" style={{ backgroundColor: "#f3f3fb", minHeight: "100vh" }}>
        ...
        <div className="container px-20">
          <div className="body mt-6 pb-2">
            <span>
              <h1 className="pb-2">EDIT INFORMATION</h1>
            </span>
            <Paper
              elevation={3}
            ...
            >
              ...
              <div className="profileField flex flex-col gap-10 mt-6">
            ...
            <span>
              <h1 className="mt-6 pb-2">SETTING</h1>
            </span>
            <div className="flex flex-row justify-between">
              <Button sx={{}} variant="contained" onClick={handleResetClick}>
