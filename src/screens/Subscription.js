...
export default function Subscription() {
  ...
  return  (
    <div className="container" style={{ backgroundColor: "#f3f3fb", minHeight:"100vh"}}>
      <div
        className="header py-6 text-center gap-10"
        style={{
          backgroundColor: "white",
          boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)",
        }}
      >
        <div className="header-content flex flex-row items-center gap-x-3 px-20">
          <InventoryIcon
      ...
      <div className="main-content flex flex-col px-20 py-10">
          ...
          {isSub ? (
            <div className="packageCard">
              ...
              <div className="packageSetting flex flex-col justify-around pl-1">
                <Button variant="text" style={{color:"red", marginBottom:"-30px"}} onClick={handleCancelPackage}>
                  Cancel package
                </Button>
        ...
        <div className="billingInfo mt-6">
          <h1>PAY</h1>
