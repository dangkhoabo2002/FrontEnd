  ...
  return (
    <div>
      ...
      <div className="bg-[#F3F8FF]">
        <div className="px-60 pb-20 py-2">
          ...
          <hr className="mt-6" />
          <div className="general-term">
            <div className="flex flex-col pt-10 pb-5" id="featureNew">
            ...
            <div className="content">
              ...
              >
                By accessing and placing an order with Master Help Desk, you
                ...
                type of communication between you and Master Help Desk.
              </p>
              <p
                className=" mb-2"
                style={{
              ...
              >
                Under no circumstances shall Master Help Desk team be liable for
                ...
                on this site, even if Master Help Desk team or an authorized
              ...
              >
                Master Help Desk will not be responsible for any outcome that
                may occur during the course of usage of our resources. We
                reserve the rights to change prices and revise the resources
                usage policy in any moment. This Terms & Conditions was created
                with{" "}
                <Link
                  to={"https://termify.io"}
                  style={{ color: "#5F94D9", textDecoration: "none" }}
                  onMouseEnter={(e) =>
          ...
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">License</div>
          </div>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk grants you a revocable, non-exclusive,
          ...
          >
            These Terms & Conditions are a contract between you and Master Help
            Desk (referred to in these Terms & Conditions as "Master Help Desk",
            "us", "we" or "our"), the provider of the Master Help Desk website
            and the services accessible from the Master Help Desk website (which
            are collectively referred to in these Terms & Conditions as the
            "Master Help Desk Service").
          </p>
          <p
            className=" mb-2"
            style={{
          ...
          >
            ...
            not agree to these Terms & Conditions, please do not use the Master
            Help Desk Service. In these Terms & Conditions, "you" refers both to
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Master Help Desk, that is responsible for your
              information under this Terms & Conditions.
            </li>
            <li>
              Country: where Master Help Desk or the owners/founders of Master
              Help Desk are based, in this case is{" "}
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Master Help
              Desk and use the services.
            </li>
            <li>
              Service: refers to the service provided by Master Help Desk as
            ...
            <li>
              Website: Master Help Desk's site, which can be accessed via this
              URL: masterhelpdesk.com
            </li>
            <li>
              You: a person or entity that is registered with Master Help Desk
              to use the Services.
            </li>
          </ul>
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of Master Help Desk or its
          ...
          >
            Thanks for shopping at Master Help Desk. We appreciate the fact that
          ...
          >
            ...
            apply to transactions at Master Help Desk. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at Master Help Desk, you agree to the
            terms along with Master Help Desk's Privacy Policy.
          </p>
          <p
            className=" mb-2"
            style={{
          ...
          >
            ...
            (collectively, "Suggestions") provided by you to Master Help Desk
            with respect to the website shall remain the sole and exclusive
            property of Master Help Desk.
          </p>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk shall be free to use, copy, modify, publish, or
          ...
          >
            ...
            Master Help Desk. We are not responsible for the content, accuracy
          ...
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">Cookies</div>
          </div>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk uses "Cookies" to identify the areas of our website
          ...
          >
            You acknowledge and agree that Master Help Desk may stop
            ...
            time. You do not need to specifically inform Master Help Desk when
            you stop using the Service. You acknowledge and agree that if Master
            Help Desk disables access to your account, you may be prevented from
          ...
          >
            Master Help Desk reserves the right to modify, suspend or
          ...
          >
            Master Help Desk may from time to time provide enhancements or
          ...
          >
            ...
            of the website. You agree that Master Help Desk has no obligation to
          ...
          >
            You acknowledge and agree that Master Help Desk shall not be
            ...
            decency, quality or any other aspect thereof. Master Help Desk does
          ...
          >
            Master Help Desk may, in its sole discretion, at any time and for
          ...
          >
            ...
            Master Help Desk, in the event that you fail to comply with any
          ...
          >
            Termination of this Agreement will not limit any of Master Help
            Desk's rights or remedies at law or in equity in case of breach by
          ...
          >
            You agree to indemnify and hold Master Help Desk and its parents,
          ...
          >
            ...
            extent permitted under applicable law, Master Help Desk, on its own
            ...
            foregoing, Master Help Desk provides no warranty or undertaking, and
          ...
          >
            Without limiting the foregoing, neither Master Help Desk nor any
            Master Help Desk's provider makes any representation or warranty of
            ...
            content, or e-mails sent from or on behalf of Master Help Desk are
          ...
          >
            ...
            liability of Master Help Desk and any of its suppliers under any
          ...
          >
            ...
            Master Help Desk or its suppliers be liable for any special,
            ...
            if Master Help Desk or any supplier has been advised of the
          ...
          >
            ...
            notices published by Master Help Desk on the Services, shall
            constitute the entire agreement between you and Master Help Desk
            ...
            Master Help Desk's failure to assert any right or provision under
            this Agreement shall not constitute a waiver of such right or
            provision. YOU AND Master Help Desk AGREE THAT ANY CAUSE OF ACTION
          ...
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">Waiver</div>
          </div>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk reserves the right, at its sole discretion, to
          ...
          >
            ...
            Master Help Desk regarding your use of the website and supersedes
            all prior and contemporaneous written or oral agreements between you
            and Master Help Desk.
          </p>
          <p
            className=" mb-2"
            style={{
          ...
          >
            ...
            when you use or purchase other Master Help Desk's services, which
            Master Help Desk will provide to you at the time of such use or
            purchase.
          </p>
          ...
          >
            ...
            arrangement thereof), are owned by Master Help Desk, its licensors
            or other providers of such material and are protected by and
            ...
            permission of Master Help Desk, unless and except as is expressly
          ...
          >
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Master Help Desk's
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and Master Help Desk
          ...
          >
            In the event of a dispute, you or Master Help Desk must give the
            ...
            <a
              ...
              class="__cf_email__"
              data-cfemail="0c7a697e656a756164683c3d4c6b616d6560226f6361"
            >
              [email&#160;protected]
            </a>
            . Master Help Desk will send any Notice of Dispute to you by mail to
            your address if we have it, or otherwise to your email address. You
            and Master Help Desk will attempt to resolve any dispute through
            informal negotiation within sixty (60) days from the date the Notice
            of Dispute is sent. After sixty (60) days, you or Master Help Desk
          ...
          >
            If you and Master Help Desk don’t resolve any dispute by informal
          ...
          >
            ...
            property of Master Help Desk without any compensation or credit to
            you whatsoever. Master Help Desk and its affiliates shall have no
          ...
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">Promotions</div>
          </div>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk may, from time to time, include contests,
          ...
          >
            ...
            signed by an authorized representative of Master Help Desk. Master
            Help Desk will be entitled to injunctive or other equitable relief
            (without the obligations of posting any bond or surety) in the event
            of any breach or anticipatory breach by you. Master Help Desk
            operates and controls the Master Help Desk Service from its offices
            ...
            Accordingly, those persons who choose to access the Master Help Desk
            ...
            include and incorporate the Master Help Desk Privacy Policy)
            contains the entire understanding, and supersedes all prior
            understandings, between you and Master Help Desk concerning its
          ...
          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">Disclaimer</div>
          </div>
          <p
            className=" mb-2"
            style={{
          ...
          >
            Master Help Desk is not responsible for any content, code or any
            other imprecision.
          </p>
          <p
            className=" mb-2"
          ...
          >
            Master Help Desk does not provide warranties or guarantees.
          </p>
          <p
            className=" mb-2"
            style={{
          ...
          >
            In no event shall Master Help Desk be liable for any special,
          ...
          >
            The Master Help Desk Service and its contents are provided "as is"
            and "as available" without any warranty or representations of any
            kind, whether express or implied. Master Help Desk is a distributor
            and not a publisher of the content supplied by third parties; as
            such, Master Help Desk exercises no editorial control over such
            ...
            merchandise provided through or accessible via the Master Help Desk
            Service. Without limiting the foregoing, Master Help Desk
            specifically disclaims all warranties and representations in any
            content transmitted on or in connection with the Master Help Desk
            Service or on sites that may appear as links on the Master Help Desk
            Service, or in the products provided as a part of, or otherwise in
            connection with, the Master Help Desk Service, including without
            ...
            oral advice or written information given by Master Help Desk or any
            ...
            Master Help Desk does not warrant that the Master Help Desk Service
            will be uninterrupted, uncorrupted, timely, or error-free.
          </p>

          <div className="flex flex-col pt-10 pb-5" id="featureNew">
            <div className="text-black text-2xl font-semibold">Contact Us</div>
          </div>
          <p
            className=" mb-2"
            style={{
