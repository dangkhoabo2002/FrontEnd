        ...
        <Box className="flex flex-row my-20">
          <div className="flex flex-col">
            ...
            <div className="px-10 mb-10" sx={{ p: 2 }}>
              ...
              <div className="border-left-4 border-solid border-blue-500 pl-2">
                <Typography variant="body1" sx={{ textAlign: "justify" }}>
                Our application emphasizes security, employing tokens and 2FA for all interactions to ensure robust protection without sacrificing speed or responsiveness. Adhering to the principle of "Selling solutions, not products," we streamline operations and provide remote server support without creating a full virtual machine.
                </Typography>
              </div>
            </div>
          </div>
